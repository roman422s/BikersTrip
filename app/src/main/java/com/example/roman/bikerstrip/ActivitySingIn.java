 ...
 */
public class ActivitySingIn extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            mStatusTextView.setText(getString(R.string.signed_in_fmt, app.getAcct().getDisplayName() + " " + app.getAcct().getEmail()));
            updateUI(true);
            if (!forceLogout) { //automatic open activity
                Intent st = new Intent(this, MainList.class);
                startActivity(st);
                // }
                finish();
            }
